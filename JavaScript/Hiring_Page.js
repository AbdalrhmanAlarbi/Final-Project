...
function renderJobs(filterKey, salaryKey, workTypes) {
    ...
    let userImgHTML = "";
    if (job.user === "مجتبى سالم") {
        userImgHTML = '<img src="../Logos/Mojtaba_Photo.png" alt="مجتبى سالم" style="width: 44px; height: 44px; border-radius: 50%; object-fit: cover;" />';
    } else if (job.user === "مصعب الككلي") {
        userImgHTML = '<img src="../Logos/Mosab_Photo.png" alt="مصعب الككلي" style="width: 44px; height: 44px; border-radius: 50%; object-fit: cover;" />';
    } else if (job.user === "والتر وايت") {
        userImgHTML = '<img src="../Logos/walter.jpg" alt="والتر وايت" style="width: 44px; height: 44px; border-radius: 50%; object-fit: cover;" />';
    } else if (job.user === "جون سنو") {
        userImgHTML = '<img src="../Logos/250116GOTJonSnow_SYK_250116-1-920x610-e1527406931583.jpg" alt="جون سنو" style="width: 44px; height: 44px; border-radius: 50%; object-fit: cover;" />';
    }
    else if (job.user === "زعيم حارة الضبع") {
        userImgHTML = '<img src="../Logos/MV5BZmJiNDQ3YzktM2EwNy00NzBmLWFiZDMtMDA3OTgwOGY3ODkxXkEyXkFqcGc@._V1_FMjpg_UX1000_.jpg" alt="جون سنو" style="width: 44px; height: 44px; border-radius: 50%; object-fit: cover;" />';
    }
    else if (job.user === "جوستاف") {
        userImgHTML = '<img src="../Logos/Clair-Obscur-Expedition-33_2024_10-16-24_008.jpg" alt="جون سنو" style="width: 44px; height: 44px; border-radius: 50%; object-fit: cover;" />';
    }
    else if (job.user === "ميسي") {
        userImgHTML = '<img src="../Logos/maxresdefault.jpg" alt="جون سنو" style="width: 44px; height: 44px; border-radius: 50%; object-fit: cover;" />';
    }
    if (isActiveUser) {
        jobCardHTML += `
