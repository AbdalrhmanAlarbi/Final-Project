const modalImages = [
      ...
      {src: '../Logos/Mojtaba/بحر/photo_2025-06-02_02-26-27.jpg', caption: 'صورة 3'}
    ];
    const redModalImages = [
      {src: '../Logos/Mojtaba/الاحمر/Artboard 1 (2).jpg', caption: 'الأحمر 1'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 2 (2).png', caption: 'الأحمر 2'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 3 (2).png', caption: 'الأحمر 3'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 3-1.png', caption: 'الأحمر 4'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 4 (2).png', caption: 'الأحمر 5'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 4-1.png', caption: 'الأحمر 6'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 4-2.png', caption: 'الأحمر 7'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 4-3.png', caption: 'الأحمر 8'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 4-4.png', caption: 'الأحمر 9'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 5 (2).png', caption: 'الأحمر 10'}
    ];
    const orangeModalImages = [
      {src: '../Logos/Mojtaba/برتقالية/EVO_للتوصيل_و_الشحن_السريع_تخزين_ب_2_دينار.jpg', caption: 'برتقالية 1'},
      {src: '../Logos/Mojtaba/برتقالية/EVO للتوصيل و الشحن السريع - ح.jpg', caption: 'برتقالية 2'},
      {src: '../Logos/Mojtaba/برتقالية/EVO_للتوصيل_و_الشحن_السريع_بوست_رقم_1_2.jpg', caption: 'برتقالية 3'},
      {src: '../Logos/Mojtaba/برتقالية/EVO_للتوصيل_و_الشحن_السريع_تجميع_مجاني.jpg', caption: 'برتقالية 4'},
      {src: '../Logos/Mojtaba/برتقالية/Artboard 1.jpg', caption: 'برتقالية 5'},
      {src: '../Logos/Mojtaba/برتقالية/Artboard 2.jpg', caption: 'برتقالية 6'},
      {src: '../Logos/Mojtaba/برتقالية/EVO_للتوصيل_و_الشحن_السريع_الحماية_الشاملة.jpg', caption: 'برتقالية 7'}
    ];
    let modalIndex = 0;
    let redModalIndex = 0;
    ...
    const matrexModalImages = [
      {src: '../Logos/Mojtaba/الاحمر/Artboard 1 (2).jpg'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 2 (2).png'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 3 (2).png'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 3-1.png'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 4 (2).png'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 4-1.png'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 4-2.png'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 4-3.png'},
      {src: '../Logos/Mojtaba/الاحمر/Artboard 4-4.png'}
    ];
    ...
    const matrexSingleModalImages = [
      {src: '../Logos/Mojtaba/الاحمر/Artboard 1 (2).jpg', caption: 'SOCIAL MEDIA DESIGN MATREX'}
    ];
    ...
    const greenModalImages = [
      {src: '../Logos/Mojtaba/الاخضر/Artboard 2.png', caption: 'اخضر 1'},
      {src: '../Logos/Mojtaba/الاخضر/Artboard 4.png', caption: 'اخضر 2'},
      {src: '../Logos/Mojtaba/الاخضر/Artboard 8.png', caption: 'اخضر 3'},
      {src: '../Logos/Mojtaba/الاخضر/Artboard 3.png', caption: 'اخضر 4'},
      {src: '../Logos/Mojtaba/الاخضر/Artboard 6.png', caption: 'اخضر 5'},
      {src: '../Logos/Mojtaba/الاخضر/Artboard 5.png', caption: 'اخضر 6'}
    ];
    ...
    const blueModalImages = [
      {src: '../Logos/Mojtaba/الازرق/ابني مستقبلك.jpg', caption: 'ازرق 1'},
      {src: '../Logos/Mojtaba/الازرق/جامعة فكر اليقين1.jpg', caption: 'ازرق 2'},
      {src: '../Logos/Mojtaba/الازرق/تعلم لاجل الغد.jpg', caption: 'ازرق 3'},
      {src: '../Logos/Mojtaba/الازرق/خارطة طريق مستقبل.jpg', caption: 'ازرق 4'},
      {src: '../Logos/Mojtaba/الازرق/فرصتك في التخصصات الرائدة.jpg', caption: 'ازرق 5'},
     {src: '../Logos/Mojtaba/الازرق/مشوارك العلمي.jpg', caption: 'ازرق 6'}
    ];
    ...
    const weatherModalImages = [
      {src: '../Logos/Mojtaba/الجو/photo_2025-06-02_02-26-33.jpg', caption: 'جو 1'},
      {src: '../Logos/Mojtaba/الجو/photo_2025-06-02_02-26-27.jpg', caption: 'جو 2'},
      {src: '../Logos/Mojtaba/الجو/photo_2025-06-02_02-26-37.jpg', caption: 'جو 3'}
    ];
